...
#[preferenceLeft][preferenceRight][rowIndex][rowEnd][columnEnd][ticker][nm1]**
...
class Generator:
    #class for generating random matchings
    ...
    def PII(preferenceStructure, n, initialMatching):
        ...
        while (not stable):
            ...
            if ITER < n:
                ...
                nm1Pairs = Improved.dynammicNM1Selection(preferenceRDD, columnMatchingLookUp, preferenceStructure, ITER)
